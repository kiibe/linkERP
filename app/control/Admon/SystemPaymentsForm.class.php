 ...
 * @author  LinkERP
 */
class SystemPaymentsForm extends TPage
{
    protected $form; // form
    ...
    function __construct()
    {
        ...
        // creates the form
        $this->form = new TForm('form_System_Payments');
        ...
        $table->addRowSet(new TLabel('Provider: '), $provider);
        ...
        $list_button->setAction(new TAction(array('SystemPaymentsList','onReload')), _t('Back to the listing'));
        $list_button->setImage('fa:table blue');

        // define the form fields
        $this->form->setFields(array($id,$provider, $amount,$description,$date,$save_button,$new_button,$list_button));
        ...
        $container->width = '80%';
        $container->addRow()->addCell(new TXMLBreadCrumb('menu.xml', 'SystemPaymentsList'));
